!(function (e) {
  function t(t) {
    for (
      var r, a, l = t[0], u = t[1], c = t[2], f = 0, d = [];
      f < l.length;
      f++
    )
      (a = l[f]),
  ...
  function (e, t, n) {
    !(function (e) {
      ...
      function i(e) {
        return function () {
          var n = this.ownerDocument,
            r = this.namespaceURI;
          return r === t && n.documentElement.namespaceURI === t
            ? n.createElement(e)
      ...
      function k(e, t, n, r, i, o) {
        for (var a, l = 0, u = t.length, c = o.length; l < c; ++l)
          (a = t[l])
      ...
      function E(e, t, n, r, i, o, a) {
        ...
        for (l = 0; l < f; ++l)
          (u = t[l]) &&
            ((p[l] = c = "$" + a.call(u, u.__data__, l, t)),
            s[c] || (s[c] = u));
        for (l = 0; l < d; ++l)
          (u = s[(c = "$" + a.call(e, o[l], l, o))])
            ? !0 !== u && ((r[l] = u), (u.__data__ = o[l]))
            : (n[l] = new x(e, o[l])),
            (s[c] = !0);
      ...
      function ce() {
        return new ue([[document.documentElement]], le);
      }
      function se(e) {
      ...
      ue.prototype = ce.prototype = {
        ...
        selectAll: function (e) {
          ...
          for (
            ...
            for (var a, l = t[o], u = l.length, c = 0; c < u; ++c)
              (a = l[c]) && (r.push(e.call(a, a.__data__, c, l)), i.push(a));
          return new ue(r, i);
        },
        filter: function (e) {
          ...
          for (
            ...
            for (
              var o, a = t[i], l = a.length, u = (r[i] = []), c = 0;
              c < l;
              ++c
            )
        ...
        data: function (e, t) {
          ...
          return (
            (this._groups = l),
            ((this._enter = new ue(u, i))._update = this),
            (this._exit = new ue(c, i)),
            this
          );
        },
        enter: function () {
          ...
          return e
            ? ((this._enter = null), e)
            : (((e = new ue(this._groups.map(_), this._parents))._update =
                this),
              e);
        },
        exit: function () {
          ...
          return e
            ? ((this._exit = null), e)
            : new ue(this._groups.map(_), this._parents);
        },
        order: function () {
        ...
        sort: function (e) {
          ...
          for (
            var n = this._groups,
              r = n.length,
              i = (this._groups = new Array(r)),
              o = 0;
            o < r;
            ++o
          ) {
            for (
              var a, l = n[o], u = l.length, c = (i[o] = new Array(u)), s = 0;
              s < u;
              ++s
            )
              (a = l[s]) && (c[s] = a);
        ...
        style: function (e, t, n) {
          ...
          return arguments.length > 1
            ? this.each(
                (null == t ? D : "function" == typeof t ? R : I)(
                  e,
                  t,
                  null == n ? "" : n
                )
        ...
        property: function (e, t) {
          return arguments.length > 1
            ? this.each((null == t ? z : "function" == typeof t ? j : A)(e, t))
            : this.node()[e];
        },
        ...
        text: function (e) {
          return arguments.length
            ? this.each(null == e ? q : ("function" == typeof e ? Q : K)(e))
            : this.node().textContent;
        },
        html: function (e) {
          return arguments.length
            ? this.each(null == e ? Y : ("function" == typeof e ? G : X)(e))
            : this.node().innerHTML;
        },
        raise: function () {
          return this.each(J);
        ...
        append: function (e, t) {
          ...
          return this.select(
            arguments.length < 2
              ? ee(n)
              : te(n, null == t ? ne : "function" == typeof t ? t : b(t))
          );
        },
        remove: function () {
          return this.each(re);
        ...
        on: function (e, t, n) {
          var r,
            ...
            a = o.length;
          if (!(arguments.length < 2)) {
            for (l = t ? y : m, null == n && (n = !1), r = 0; r < a; ++r)
              this.each(l(o[r], t, n));
            return this;
          }
      ...
      var fe =
        "undefined" != typeof navigator && /WebKit/.test(navigator.userAgent)
          ? -1
          : 0;
      function de(e, t) {
      ...
      (e.version = "0.6.12"),
        ...
        (e.selectAll = function (e) {
          return "string" == typeof e
            ? new ue([document.querySelectorAll(e)], [document.documentElement])
            : new ue([e], le);
        }),
        (e.selection = ce),
        (e.selector = b),
...
*/ var r = Object.getOwnPropertySymbols,
  ...
  function (e, t, n) {
    ...
    function c(e, t) {
      ...
      (this.filter = e),
        (this.id = "filter-component-" + r++),
        (this.componentName = i[t]),
        (this.filterComponent = e.append(this.componentName)),
    ...
    (e.exports = c),
      ...
      (c.prototype.attr = function () {
        return 1 === arguments.length
          ...
          : (arguments.length &&
              u[this.componentName] &&
              u[this.componentName][arguments[0]] &&
              (arguments[0] = u[this.componentName][arguments[0]]),
            this.filterComponent.attr.apply(this.filterComponent, arguments),
            this);
      }),
      (c.prototype.append = function (e) {
        ...
        return t
          ? new l(this.filterComponent, t)
          : this.filterComponent.append.apply(this.filterComponent, arguments);
      });
  },
  function (e) {
  ...
  function (e, t, n) {
    ...
    var r = function (e, t) {
      ...
      return (e) => {
        if ("string" != typeof e)
          throw new TypeError(
            "expected an argument of type string, but got ".concat(
              typeof styleObj
            )
          );
  ...
  function (e, t, n) {
    ...
    (t.default = u),
      (e.exports = r.default),
      (e.exports.createParser = i.default),
      (e.exports.parsers = (function (e) {
  ...
  function (e) {
    e.exports = JSON.parse(
      '[{"start":"400","end":"700","text":"My name is ARJUN KUMAR DUBEY"},{"start":"700","end":"900","text":"I\'m a self-trained app dev"},{"start":"1000","end":"1200","text":"I\'am  a mechanical+software engineer,"},{"start":"1200","end":"1400","text":"an student,"},{"start":"1600","end":"1800","text":"and have a aim to be entrepreneur."},{"start":"2000","end":"2300","text":"In 2016 I left Rajasthan and moved to New-Delhi (ayanagar)"},{"start":"2400","end":"2500","text":"(with a train actually)"},{"start":"2600","end":"2800","text":"best transition of my life 🤗"},{"start":"2900","end":"3300","text":"I\'ve met amazing engineers on discord that made me a much better developer"},{"start":"3400","end":"3700","text":"In 2016 I joined kendriya vidyalaya as a 5th grade student. great school!"},{"start":"3800","end":"4000","text":"And not just this, a few things happened in my personal life as well which i cant tell"},{"start":"4500","end":"4700","text":"When I can I like to contribute to the RSS community"},{"start":"4800","end":"5100","text":"publishing code on my github profile"},{"start":"5100","end":"5400","text":"writing about building apps"},{"start":"5400","end":"5700","text":"or contributing to other open source projects"},{"start":"5700","end":"6000","text":"But the most important thing of all,"},{"start":"6001","end":"6003","text":"dskf sdkjf98sy d9f8u"}]'
    );
  },
  ,
  function (e, t, n) {
  ...
  function (e, t, n) {
    ...
    function Ne(e, t) {
      ...
      t.hasOwnProperty("value")
        ? De(e, t.type, n)
        : t.hasOwnProperty("defaultValue") && De(e, t.type, Ee(t.defaultValue)),
        null == t.checked &&
    ...
    function kt(e, t, n, r, i) {
      return null === e || e.nativeEvent !== i
        ? ((e = bt(t, n, r, i)), null !== t && null !== (t = sr(t)) && lt(t), e)
    ...
    function Ct(e) {
      ...
      for (; 0 < yt.length && null === (n = yt[0]).blockedOn; )
        Et(n), null === n.blockedOn && yt.shift();
    }
    function Pt(e) {
      return (
    ...
    var Wt = jt.extend({
      ...
      Vt = jt.extend({ view: null, detail: null }),
      ...
      var Gt = Vt.extend({
        ...
        nn = Vt.extend({
          ...
          movementX: function (e) {
            ...
            return (
              (Jt = e.screenX),
              en ? ("mousemove" === e.type ? e.screenX - t : 0) : ((en = !0), 0)
            );
          },
          movementY: function (e) {
            ...
            return (
              (Zt = e.screenY),
              tn ? ("mousemove" === e.type ? e.screenY - t : 0) : ((tn = !0), 0)
            );
          },
        }),
        rn = nn.extend({
        ...
        on = nn.extend({ dataTransfer: null }),
        an = Vt.extend({
          touches: null,
          targetTouches: null,
          changedTouches: null,
            ...
            : (function (e, t, n, r) {
                switch (t) {
                  ...
                  case "gotpointercapture":
                    return (
                      (i = r.pointerId),
                      mt.set(i, kt(mt.get(i) || null, e, t, n, r)),
                      !0
                    );
                }
                return !1;
        ...
        extractEvents: function (e, t, n, r) {
          ...
          return (
            ...
            (e = Er
              ...
              ? (((t = gr.getPooled(Sr.beforeInput, t, n, r)).data = e), Rt(t))
              : (t = null),
    ...
    function Vr(e, t, n) {
      "focus" === e
        ? (Wr(), (Ar = n), (zr = t).attachEvent("onpropertychange", Br))
        : "blur" === e && Wr();
    }
    function $r(e) {
    ...
    function ai(e, t) {
      ...
      return oi || null == ni || ni !== qn(n)
        ? null
        : ("selectionStart" in (n = ni) && Xn(n)
          ...
          ii && Zr(ii, n)
            ? null
            : ((ii = n),
              ((e = jt.getPooled(ti.select, ri, e, t)).type = "select"),
              (e.target = ni),
              Rt(e),
              e));
    }
    ...
    function Ei(e) {
      var t = e.stateNode;
      return (
        (t = (t && t.__reactInternalMemoizedMergedChildContext) || di),
        (mi = pi.current),
        fi(pi, t),
        fi(hi, hi.current),
        !0
    ...
    if (null == a.__interactionsRef || null == a.__interactionsRef.current)
      throw Error(l(302));
    var Ai = {},
    ...
    function yo(e, t) {
      ...
      if (null === n) {
        ...
        (r = e.updateQueue),
          ...
          null === r
            ? null === i
              ? ((r = e.updateQueue = fo(e.memoizedState)),
                (i = n.updateQueue = fo(n.memoizedState)))
              : (r = e.updateQueue = po(i))
            : null === i && (i = n.updateQueue = po(r));
      null === i || r === i
        ? mo(r, t)
        : null === r.lastUpdate || null === i.lastUpdate
        ? (mo(r, t), mo(i, t))
        : (mo(r, t), (i.lastUpdate = t));
    }
    function vo(e, t) {
      var n = e.updateQueue;
      null ===
      ...
      return (
        "object" == typeof o && null !== o
          ...
          : ((i = vi(t) ? mi : pi.current),
            (o = (r = null != (r = t.contextTypes)) ? yi(e, i) : di)),
        (t = new t(n, o)),
        (e.memoizedState =
    ...
    function No(e, t, n, r) {
      ...
      "object" == typeof o && null !== o
        ...
        null !== (o = e.updateQueue) &&
          (wo(e, o, n, i, r), (i.state = e.memoizedState)),
    ...
    function Ro(e) {
      ...
      function c(e, t, n, r) {
        return null !== t && t.elementType === n.type
          ? (((r = i(t, n.props)).ref = Do(e, t, n)), (r.return = e), r)
          : (((r = Ju(n.type, n.key, n.props, null, e.mode, r)).ref = Do(
              e,
              t,
              n
            )),
      ...
      function d(e, t, n) {
        ...
        if ("object" == typeof t && null !== t) {
          switch (t.$$typeof) {
            case j:
              return (
                ((n = Ju(t.type, t.key, t.props, null, e.mode, n)).ref = Do(
                  e,
                  null,
                  t
                )),
          ...
          switch (o.$$typeof) {
            case j:
              e: {
                ...
                o.type === F
                  ? (((r = Zu(o.props.children, e.mode, u, o.key)).return = e),
                    (e = r))
                  : (((u = Ju(o.type, o.key, o.props, null, e.mode, u)).ref =
                      Do(e, r, o)),
                    (u.return = e),
                    (e = u));
              }
        ...
        if ("string" == typeof o || "number" == typeof o)
          return (
            ...
            null !== r && 6 === r.tag
              ...
              : (n(e, r), ((r = ec(o, e.mode, u)).return = e), (e = r)),
            a(e)
          );
    ...
    function da(e, t, n, r, i, o) {
      ...
      if (
        ((Yo.current = Na),
        ((e = Jo).memoizedState = ta),
        (e.expirationTime = ia),
        (e.updateQueue = oa),
        (e.effectTag |= aa),
        (e = null !== Zo && null !== Zo.next),
        (Go = 0),
        (ra = na = ta = ea = Zo = Jo = null),
        (ia = 0),
        (oa = null),
        (aa = 0),
        e)
    ...
    function ma() {
      if (null !== ra)
        (ra = (na = ra).next), (ea = null !== (Zo = ea) ? Zo.next : null);
      else {
    ...
    function wa(e, t, n, r) {
      return (
        ...
        null === oa
          ...
          : ((n = t.next), (t.next = e), (e.next = n), (oa.lastEffect = e)),
        e
      );
    }
    function ka(e, t, n, r) {
    ...
    function Ea(e, t, n, r) {
      ...
      if (null !== Zo) {
        ...
        if (((o = a.destroy), null !== r && fa(r, a.deps)))
          return void wa(0, n, o, r);
      }
    ...
    function Xa(e, t, n, r, i, o) {
      if (null === e) {
        ...
        return "function" != typeof a ||
          ...
          ? (((e = Ju(n.type, null, r, null, t.mode, o)).ref = t.ref),
            (e.return = t),
            (t.child = e))
    ...
    function el(e, t, n, r, i) {
      ...
      if ((uo(t, i), null === t.stateNode))
        ...
        null !== p && (wo(t, p, r, a, i), (u = t.memoizedState)),
          l !== r || d !== u || hi.current || so
            ? ("function" == typeof s &&
                (So(t, n, s, r), (u = t.memoizedState)),
              (l = so || Co(t, n, l, r, d, u, c))
                ? (f ||
        ...
        (a = t.stateNode),
          (l = t.memoizedProps),
          (a.props = t.type === t.elementType ? l : Zi(t.type, l)),
          (u = a.context),
          ...
          null !== (p = t.updateQueue) &&
            (wo(t, p, r, a, i), (d = t.memoizedState)),
          l !== r || u !== d || hi.current || so
            ? ("function" == typeof s &&
                (So(t, n, s, r), (d = t.memoizedState)),
              (s = so || Co(t, n, l, r, u, d, c))
                ? (f ||
    ...
    function ll(e, t, n) {
      ...
      if (null !== e.memoizedState) {
        if (((i = (e = e.child).sibling), l)) {
          ...
          if (8 & t.mode) {
            for (l = 0, e = n.child; null !== e; )
              (l += e.treeBaseDuration), (e = e.sibling);
            n.treeBaseDuration = l;
          }
          return (
            ((i = Gu(i, o, i.expirationTime)).return = t),
            (n.sibling = i),
      ...
      if (((e = e.child), l)) {
        if (
          ...
          for (
            ...
            (e.return = o), (e = e.sibling);
        if (8 & t.mode) {
          for (e = 0, a = o.child; null !== a; )
            (e += a.treeBaseDuration), (a = a.sibling);
    ...
    function sl(e, t, n) {
      var r = t.pendingProps,
        i = r.revealOrder,
        o = r.tail;
      if ((Qa(e, t, r.children, n), 0 != (2 & (r = qo.current))))
        ...
        switch (i) {
          case "forwards":
            for (n = t.child, i = null; null !== n; )
              null !== (e = n.alternate) && null === Ko(e) && (i = n),
                (n = n.sibling);
            null === (n = i)
              ? ((i = t.child), (t.child = null))
              : ((i = n.sibling), (n.sibling = null)),
              cl(t, !1, i, n, o, t.lastEffect);
            break;
          case "backwards":
    ...
    function fl(e, t, n) {
      ...
      if (null !== t.child) {
        for (
          ...
          (e = e.sibling),
            ((n = n.sibling = Gu(e, e.pendingProps, e.expirationTime)).return =
              t);
        n.sibling = null;
      }
      return t.child;
    ...
    function hl(e, t, n) {
      ...
      switch (t.tag) {
                  ...
                  "children" === u
                    ? "string" == typeof c
                      ...
                      : "number" == typeof c &&
                        r.textContent !== "" + c &&
                        (e = ["children", "" + c])
                    : h.hasOwnProperty(u) && null != c && $n(n, u);
                }
              switch (o) {
                case "input":
                  Se(r), Me(r, a, !0);
        ...
        case 11:
          break;
        case 13:
          if ((si(qo), (r = t.memoizedState), 0 != (64 & t.effectTag)))
          ...
          (n = null !== r),
            ...
            n &&
              ...
              0 != (1 & qo.current)
                ? Vl === Al && (Vl = jl)
                : ((Vl !== Al && Vl !== jl) || (Vl = Ll),
                  0 !== Ql && null !== Ul && (ic(Ul, Bl), oc(Ul, Ql)))),
            (n || r) && (t.effectTag |= 4);
          break;
        case 7:
        case 8:
                  ...
                  for (
                    ...
                    (e = n),
                      ...
                      null === (a = o.alternate)
                        ...
                        : ((o.childExpirationTime = a.childExpirationTime),
                          ...
                          (o.selfBaseDuration = a.selfBaseDuration),
                          (o.treeBaseDuration = a.treeBaseDuration)),
                      (r = r.sibling);
    ...
    function Ml(e, t, n) {
      ...
      return (
        null !== o &&
          ...
          (n.callback = function () {
            "function" != typeof r &&
              (null === eu ? (eu = new Set([this])) : eu.add(this), gl(e, t));
            var n = t.stack;
    ...
    function pu(e, t) {
      ...
      return (
        null !== i && (Ul === i && (Su(t), Vl === Ll && ic(i, Bl)), oc(i, t)), i
      );
    }
    function hu(e) {
    ...
    function mu(e) {
      if (0 !== e.lastExpiredTime)
        (e.callbackExpirationTime = 1073741823),
          ...
          (e.callbackNode = Ki(vu.bind(null, e)));
      else {
        var t = hu(e),
          n = e.callbackNode;
        if (0 === t)
    ...
    function yu(e, t) {
      ...
      if (0 !== n) {
        ...
        if (
          (Ru(), (e === Ul && n === Bl) || (wu(e, n), Vu(e, n)), null !== Wl)
        ) {
          var r = Fl;
          Fl |= 16;
          for (var i = Eu(), o = xu(e); ; )
          ...
          if (
            ...
            (Fl = r),
            (Rl.current = i),
            (a.__interactionsRef.current = o),
            1 === Vl)
          )
            throw ((t = $l), wu(e, n), ic(e, n), mu(e), t);
          if (null === Wl)
            switch (
              ...
              case jl:
                if (
                  ...
                  n === (r = e.lastSuspendedTime) &&
                    (e.nextKnownPendingLevel = Nu(i)),
                  1073741823 === Hl && 10 < (i = Xl + 500 - Bi()))
                ) {
    ...
    function vu(e) {
      ...
      if (((t = 0 !== t ? t : 1073741823), e.finishedExpirationTime === t))
        ...
        if (
          (Ru(), (e === Ul && t === Bl) || (wu(e, t), Vu(e, t)), null !== Wl)
        ) {
          var n = Fl;
          Fl |= 16;
          for (var r = Eu(), i = xu(e); ; )
          ...
          if (
            ...
            (Fl = n),
            (Rl.current = r),
            (a.__interactionsRef.current = i),
            1 === Vl)
          )
            throw ((n = $l), wu(e, t), ic(e, t), mu(e), n);
    ...
    function ku(e, t) {
      for (;;) {
        try {
          if ((io(), pa(), null === Wl || null === Wl.return))
            return (Vl = 1), ($l = t), null;
          8 & Wl.mode && Aa(Wl, !0);
          e: {
            var n = e,
              r = Wl.return,
    ...
    function Pu(e) {
      ...
      return (
        0 != (8 & e.mode)
          ? ((za = Ia()),
            0 > e.actualStartTime && (e.actualStartTime = Ia()),
            (t = Dl(t, e, Bl)),
            Aa(e, !0))
          : (t = Dl(t, e, Bl)),
      ...
      do {
        ...
        if (((e = Wl.return), 0 == (2048 & Wl.effectTag))) {
          if (0 == (8 & Wl.mode)) t = hl(t, Wl, Bl);
            ...
            var n = Wl;
            (za = Ia()),
              0 > n.actualStartTime && (n.actualStartTime = Ia()),
              (t = hl(t, Wl, Bl)),
              Aa(Wl, !1);
          }
          if (((n = Wl), 1 === Bl || 1 !== n.childExpirationTime)) {
            ...
            if (0 != (8 & n.mode)) {
              for (
                var i = n.actualDuration,
                  o = n.selfBaseDuration,
              ...
              for (i = n.child; null !== i; )
                (o = i.expirationTime) > r && (r = o),
                  (a = i.childExpirationTime) > r && (r = a),
                  (i = i.sibling);
          ...
          if (((t = ml(Wl)), 0 != (8 & Wl.mode))) {
            for (Aa(Wl, !1), n = Wl.actualDuration, r = Wl.child; null !== r; )
    ...
    function Du(e, t) {
            ...
            e: {
              ...
              if (f && 0 !== f.rangeCount) {
                ...
                t: for (;;) {
                  for (
                    var k;
                    b !== s || (0 !== d && 3 !== b.nodeType) || (m = h + d),
                      b !== p || (0 !== f && 3 !== b.nodeType) || (y = h + f),
                ...
                s = -1 === m || -1 === y ? null : { start: m, end: y };
              } else s = null;
            }
          s = s || { start: 0, end: 0 };
        } else s = null;
        (Jn = { focusedElem: c, selectionRange: s }), (Sn = !1), (Gl = i);
        do {
          try {
            Iu();
          } catch (e) {
            ...
            "selectionStart" in E
              ...
              : (_ =
                ...
                d &&
                  ...
                  (1 !== _.rangeCount ||
                    _.anchorNode !== d.node ||
                    _.anchorOffset !== d.offset ||
                    _.focusNode !== p.node ||
                    _.focusOffset !== p.offset) &&
                  ((x = x.createRange()).setStart(d.node, d.offset),
                  _.removeAllRanges(),
                  c > s
                    ? (_.addRange(x), _.extend(p.node, p.offset))
                    : (x.setEnd(p.node, p.offset), _.addRange(x))))),
            (x = []);
      ...
      if (0 !== (t = e.firstPendingTime)) {
        if (null !== uu)
          for (i = uu, uu = null, T = 0; T < i.length; T++)
            Wu(e, i[T], e.memoizedInteractions);
        Bu(e, t);
      } else eu = null;
      if (
        (S || $u(e, r),
    ...
    function Au(e, t, n) {
      yo(e, (t = Nl(e, (t = yl(n, t)), 1073741823))),
        null !== (e = pu(e, 1073741823)) && (mu(e), Bu(e, 1073741823));
    }
    function ju(e, t) {
      if (3 === e.tag) Au(e, e, t);
      else
        for (var n = e.return; null !== n; ) {
          ...
          if (1 === n.tag) {
            ...
            if (
              ...
              yo(n, (e = Ml(n, (e = yl(t, e)), 1073741823))),
                null !== (n = pu(n, 1073741823)) && (mu(n), Bu(n, 1073741823));
              break;
            }
          }
          n = n.return;
    ...
    function Lu(e, t, n) {
      ...
      null !== r && r.delete(t),
        Ul === e && Bl === n
          ? Vl === Ll || (Vl === jl && 1073741823 === Hl && Bi() - Xl < 500)
            ? wu(e, Bl)
            : (Yl = !0)
          : rc(e, n) &&
    ...
    function Fu(e, t) {
      var n = e.stateNode;
      null !== n && n.delete(t),
        0 === (t = 0) && (t = fu((t = su()), e, null)),
        null !== (e = pu(e, t)) && (mu(e), Bu(e, t));
    }
    function Uu(e) {
    ...
    function Wu(e, t, n) {
      if (0 < n.size) {
        ...
        null != i
          ...
          null !== (r = a.__subscriberRef.current) &&
            ...
            switch (((Ka = !1), t.tag)) {
              ...
              case 5:
                if (($o(t), 4 & t.mode && 1 !== n && i.hidden))
                  return (
                    Uu(1), (t.expirationTime = t.childExpirationTime = 1), null
                  );
                break;
              case 1:
                vi(t.type) && Ei(t);
              ...
              case 13:
                if (null !== t.memoizedState)
                  return 0 !== (r = t.child.childExpirationTime) && r >= n
                    ? ll(e, t, n)
                    : (fi(qo, 1 & qo.current),
                      null !== (t = fl(e, t, n)) ? t.sibling : null);
                fi(qo, 1 & qo.current);
                break;
              case 19:
                if (
      ...
      switch (((t.expirationTime = 0), t.tag)) {
        ...
        case 1:
          return (
            (r = t.type),
            (i = t.pendingProps),
            el(e, t, r, (i = t.elementType === r ? i : Zi(r, i)), n)
          );
        case 3:
          ...
          if (
            ...
            if (
              ((i = t.stateNode.hydrate) &&
                ((La = rr(t.stateNode.containerInfo.firstChild)),
                (ja = t),
                (i = Fa = !0)),
              i)
            )
        ...
        case 5:
          return (
            ...
            er(r, i)
              ? (a = null)
              : null !== o && er(r, o) && (t.effectTag |= 16),
            Ja(e, t),
            4 & t.mode && 1 !== n && i.hidden
              ? (Uu(1),
                (t.expirationTime = t.childExpirationTime = 1),
                (t = null))
              : (Qa(e, t, a, n), (t = t.child)),
            t
          );
        case 6:
        ...
        case 4:
          return (
            Bo(t, t.stateNode.containerInfo),
            (r = t.pendingProps),
            null === e ? (t.child = zo(t, null, r, n)) : Qa(e, t, r, n),
            t.child
          );
        case 11:
          return (
            (r = t.type),
            (i = t.pendingProps),
            Ya(e, t, r, (i = t.elementType === r ? i : Zi(r, i)), n)
          );
        case 7:
        ...
        case 12:
          return (
            (t.effectTag |= 4), Qa(e, t, t.pendingProps.children, n), t.child
          );
        case 10:
          e: {
            if (
                  ...
                  if (null !== c) {
                    ...
                    for (var s = c.firstContext; null !== s; ) {
                      if (s.context === r && 0 != (s.observedBits & o)) {
                        1 === u.tag && (((s = ho(n, null)).tag = 2), yo(u, s)),
    ...
    function Ju(e, t, n, r, i, o) {
      ...
      if (((r = e), "function" == typeof e)) Xu(e) && (a = 1);
        ...
        e: switch (e) {
          ...
          case K:
            return (
              ((e = Yu(19, n, t, i)).elementType = K), (e.expirationTime = o), e
            );
          default:
      ...
      (this.tag = t),
        ...
        (this.lastExpiredTime =
          ...
          this.firstPendingTime =
            0),
        (this.interactionThreadID = a.unstable_getThreadID()),
      ...
      try {
        for (
          ...
          if (null !== l) {
            ...
            (n = t.unstable_now()),
              "function" == typeof u ? (D.callback = u) : D === T(O) && C(O),
              j(n);
          } else C(O);
          D = T(O);
        }
      ...
      (t.unstable_scheduleCallback = function (e, n, a) {
        ...
        return (
          ...
          u > l
            ? ((e.sortIndex = u),
              S(N, e),
              null === T(O) && e === T(N) && (A ? o() : (A = !0), i(L, u - l)))
            : ((e.sortIndex = a), S(O, e), z || R || ((z = !0), r(F))),
          e
        );
      }),
    ...
    (o = new Set()),
      ...
      (t.unstable_trace = function (e, n, i) {
        var o =
          ...
          a = { __count: 1, id: r++, name: e, timestamp: n },
            ...
            try {
              ...
              try {
                ...
                a.__count--,
                  null !== c &&
                    0 === a.__count &&
                    c.onInteractionScheduledWorkCompleted(a);
              }
            }
          }
        }
  ...
  function (e, t, n) {
    ...
    function c() {
      ...
      (this.id = "svg-filter-" + l++),
        r ||
          (r = i.select("body").append("svg").attr("height", 0).append("defs")),
        (this.filter = r.append("filter")),
    ...
    (e.exports = c),
      ...
      (c.prototype.append = function (e) {
        ...
        return t
          ? new a(this.filter, t)
          : this.filter.append.apply(this.filter, arguments);
      }),
      (c.prototype.attr = function () {
        return 1 === arguments.length
          ? this.filter.attr.apply(this.filter, arguments)
          : (this.filter.attr.apply(this.filter, arguments), this);
      }),
  ...
  function (e) {
    e.exports = JSON.parse(
      '{"feFlood":{"opacity":"flood-opacity","color":"flood-color"}}'
    );
  },
  function (e, t, n) {
    "use strict";
    ...
    var i = function (e, t = r.camelToKebab) {
      if (!e || "object" != typeof e || Array.isArray(e))
        throw new TypeError(
          "expected an argument of type object, but got ".concat(typeof e)
        );
      return Object.keys(e)
        .map((n) => "".concat(t(n), ": ").concat(e[n], ";"))
        .join("\n");
    };
    t.default = i;
  },
  ...
  function (e, t, n) {
    ...
    var r,
      ...
      h = function (e, t) {
        p ||
          ...
          (addEventListener("beforeunload", function () {}), (p = !0)),
          addEventListener(
            "visibilitychange",
            function n(r) {
      ...
      v = function (e, t, n) {
        ...
        return function () {
          t.value >= 0 &&
            (n || y.has(t) || "hidden" === document.visibilityState) &&
            ((t.delta = t.value - (r || 0)),
    ...
    var M = function (e) {
      ...
      z = function (e, t) {
        for (var n = {}, r = 0; r < t; r++)
          (n[e + 400 * r] = {
            opacity: 0,
            transform: R(
              I(0, parseInt(0 - 100 * Math.random() - 100, 10)),
              D(1, 1)
            ),
          }),
            (n[e + 400 * r + 1] = {
      ...
      j = function (e) {
        var t,
          n =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1;
        return N((t = {}), e, { opacity: 1 }), N(t, e + n, { opacity: 0 }), t;
      },
      L = function (e, t, n, r) {
      ...
      F = function () {
        var e,
          ...
          a = { transform: R(I(0, 0), D(1), M(0)) },
          l = { transform: R(I(0, 0), D(0.8), M(0)) };
        return (
          N((e = { 0: a }), o - 70, a),
          N(e, o - 20, { transform: R(I(t, n), D(r), M(i)) }),
          N(e, o, l),
          N(e, o + 20, a),
          e
        );
      ...
      U = function () {
        var e,
          ...
          i = 100 * r;
        return (
          N((e = { 0: { opacity: 0 } }), 0 + t - 1, { opacity: 0 }),
          N(e, 0 + t, {
            opacity: 1,
            strokeDashoffset: n,
            strokeDasharray: n,
      ...
      W = function (e, t, n) {
        var r,
          i =
            arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 80,
          o = 50 * n;
        return O(
          O({}, U(e, t, n)),
          (N((r = {}), e + i - 20, {
      ...
      B = function (e, t) {
        for (var n = parseInt((t - e) / 50, 10), r = {}, i = 0; i < n; i++)
          r[e + 50 * i] = {
    ...
    var K = 8200,
      Q = function (e) {
        var t,
          ...
          X = e ? R(I(800, -100), D(0.5)) : R(I(700, -300), D(0.3)),
        ...
        return new Map([
          [
            "scrollhint",
            {
              0: { transform: e ? R(I(-0, -0), D(4)) : R(I(0, 0), D(1)) },
              2: {
                opacity: 1,
          ...
          [
            "container",
            ((t = { 0: { transform: J } }),
            q(t, C[0] - 50, { transform: J }),
            q(t, C[0], { transform: Z }),
            q(t, P[0], { transform: Z }),
            q(t, P[0] + 20, { transform: ee }),
            q(t, P[1] - 30, { transform: ee }),
            q(t, O[0], { transform: te }),
            q(t, O[1] - 30, { opacity: 1, transform: te }),
            q(t, O[1], { transform: te, opacity: 0 }),
            t),
          ],
          [
            "helloline",
            H(
              ((n = {}),
              q(n, 210, { strokeDashoffset: 300 }),
              q(n, 440, { strokeDashoffset: 0 }),
              n),
              j(C[0])
            ),
          ],
          [
            "desktopsource path",
            ((r = { 0: { opacity: 0 } }),
            q(r, C[0] - 240, { opacity: 0, fillOpacity: 0, strokeOpacity: 0 }),
            q(r, C[0] - 220, { opacity: 1, fillOpacity: 1, strokeOpacity: 1 }),
            r),
          ],
          ...
          [
            "lines :nth-child(1n)",
            ((i = {}),
            q(i, C[0] - 260, { opacity: 0 }),
            q(i, C[0] - 220, { opacity: 1 }),
            i),
          ],
          [
            "lines :nth-child(2n)",
            ((o = {}),
            q(o, C[0] - 240, { opacity: 0 }),
            q(o, C[0] - 200, { opacity: 1 }),
            o),
          ],
          ...
          [
            "desktableshadow",
            H(H({}, L(C[0] + 86, 30, C[1] - 50)), A(P[0] + 20)),
          ],
          ...
          ["logo1", W(P[0], 60, 0.25)],
          ["logo2 *", W(P[0] + 50, 60, 0.25)],
          ["logo3 *", W(P[0] + 100, 60, 0.25)],
          ["logo4 *", W(P[0] + 150, 60, 0.25)],
          ["logo5 *", W(P[0] + 200, 60, 0.25)],
          ["logo6 *", W(P[0] + 250, 60, 0.25)],
          ["logo7 *", W(P[0] + 300, 60, 0.25)],
          ["logo8 *", W(P[0] + 350, 60, 0.25)],
          ["logo9 *", W(P[0] + 400, 60, 0.25)],
          ["logo10 *", W(P[0] + 450, 60, 0.25)],
          ...
          [
            "founderwalls",
            ((a = {}),
            q(a, O[0], { transform: I(0, 100), opacity: 0 }),
            q(a, O[0] + 20, { opacity: 1, transform: I(0, 0) }),
            a),
          ],
          [
            "founderinterior",
            ((l = {}),
            q(l, O[0], { transform: I(0, 100), opacity: 0 }),
            q(l, O[0] + 20, { opacity: 1, transform: I(0, 0) }),
            l),
          ],
          ["frame", A(N[0], 100)],
          [
            ...
            H(
              ...
              {},
              ((u = {}),
              q(u, N[0], { transform: I(-300, 0) }),
              q(u, N[1], { transform: I(520, 0) }),
              u)
            ),
          ],
          ["rome", j(N[1])],
          [
            "hotballoon",
            ((c = {}),
            q(c, N[0], { transform: R(I(-160, 140), M(0)) }),
            q(c, N[1] - 200, { transform: R(I(-130, -20), M(0)) }),
            q(c, N[1], { transform: R(I(-180, 10), M(20)) }),
            q(c, N[1] + 200, { transform: R(I(-200, 20), M(20)) }),
            c),
          ],
          [
            "framemasked",
            ((s = { 0: { clipPath: "none" } }),
            q(s, N[1], { clipPath: "none" }),
            q(s, N[1] + 1, { clipPath: "url(#framemask_1_)" }),
            s),
          ],
          ["leftroom", A(N[1], 1)],
          ...
          [
            ...
            H(
              ...
              {},
              ((f = {}),
              q(f, N[0] - 1, { transform: K }),
              q(f, N[0] + 1, { transform: K }),
              q(f, N[1], { transform: K }),
              q(f, N[1] + 400, { transform: Q }),
              q(f, N[1] + 1e3, { transform: Y }),
              q(f, N[1] + 1600, { transform: X }),
              q(f, V[0] + 400, { transform: X }),
              q(f, V[0] + 600, { transform: G }),
              f)
            ),
          ],
          [
            "chairshadow",
            ((d = {}),
            q(d, V[0], { transform: R(I(0, 0), D(0.8, 1)), opacity: 0.6 }),
            q(d, V[0] + 300, { transform: R(I(0, 0), D(1, 1)), opacity: 0 }),
            d),
          ],
          [
            "tableshadow",
            ((p = { 0: { opacity: 0 } }),
            q(p, V[0], { transform: R(I(0, 0), D(0.8, 1)), opacity: 0.6 }),
            q(p, V[0] + 300, { transform: R(I(0, 0), D(1, 1)), opacity: 0 }),
            p),
          ],
          [
            "table2shadow",
            ((h = { 0: { opacity: 0 } }),
            q(h, V[0], { transform: R(I(0, 0), D(0.8, 1)), opacity: 0.6 }),
            q(h, V[0] + 300, { transform: R(I(0, 0), D(1, 1)), opacity: 0 }),
            h),
          ],
          [
            "dodge",
            ((m = { 0: { opacity: 0 } }),
            q(m, V[0], { transform: R(I(-100, 0), D(1)), opacity: 1 }),
            q(m, V[0] + 500, { transform: R(I(-200, 0), D(1.6)), opacity: 0 }),
            m),
          ],
          [
            "light",
            ((y = { 0: { opacity: 0 } }),
            q(y, V[0] + 349, { opacity: 0 }),
            q(y, V[0] + 350, { opacity: 0.4 }),
            y),
          ],
          [
            "light2",
            ((v = { 0: { opacity: 0 } }),
            q(v, V[0] + 349, { opacity: 0 }),
            q(v, V[0] + 350, { opacity: 0.4 }),
            v),
          ],
          [
            "dark1",
            ((g = { 0: { opacity: 0 } }),
            q(g, V[0], { opacity: 0 }),
            q(g, V[0] + 300, { opacity: 0 }),
            q(g, V[0] + 400, { opacity: 0.7 }),
            g),
          ],
          [
            "dark2",
            ((b = { 0: { opacity: 0 } }),
            q(b, V[0], { opacity: 0 }),
            q(b, V[0] + 349, { opacity: 0.7 }),
            q(b, V[0] + 350, { opacity: 0 }),
            b),
          ],
          ["smoke1", z(V[0] - 100, 7)],
          ["smoke2", z(V[0], 7)],
          [
            "window1",
            ((w = { 0: { opacity: 0 } }),
            q(w, V[0] + 800, { opacity: 0, transform: D(0.7) }),
            q(w, V[0] + 830, { opacity: 1, transform: D(1) }),
            q(w, $[0] - 300, { opacity: 1, transform: D(1) }),
            q(w, $[0] - 270, { opacity: 0, transform: D(0.7) }),
            w),
          ],
          [
            "terminal1",
            ((k = { 0: { opacity: 0 } }),
            q(k, V[0] + 600, { opacity: 0, transform: D(0.7) }),
            q(k, V[0] + 630, { opacity: 1, transform: D(1) }),
            q(k, $[0] - 300, { opacity: 1, transform: D(1) }),
            q(k, $[0] - 270, { opacity: 0, transform: D(0.7) }),
            k),
          ],
          [
            "terminal2",
            ((E = { 0: { opacity: 0 } }),
            q(E, $[0] - 400, { opacity: 0, transform: D(0.7) }),
            q(E, $[0] - 370, { opacity: 1, transform: D(1) }),
            E),
          ],
          [
            "terminal2textclip",
            ((x = {}),
            q(x, $[0] - 300, { transform: D(1, 1) }),
            q(x, $[0] - 200, { transform: D(2.6, 1) }),
            x),
          ],
          [
            "terminal2cursor",
            ((_ = {}),
            q(_, $[0] - 300, { transform: I(0, 0) }),
            q(_, $[0] - 201, { transform: I(52, 0) }),
            q(_, $[0] - 200, { transform: I(28, 12) }),
            _),
          ],
    ...
    function ye(e) {
      ...
      return (
        ...
        (t = ae.exec(e))
          ...
          ? ge(t[1], t[2], t[3], t[4])
          : (t = se.exec(e))
          ? ge((255 * t[1]) / 100, (255 * t[2]) / 100, (255 * t[3]) / 100, t[4])
          : (t = fe.exec(e))
          ? Se(t[1], t[2] / 100, t[3] / 100, 1)
          : (t = de.exec(e))
          ? Se(t[1], t[2] / 100, t[3] / 100, t[4])
          : pe.hasOwnProperty(e)
          ? ve(pe[e])
          : "transparent" === e
    ...
    function be(e) {
      return (
        e instanceof ne || (e = ye(e)),
        e ? new ke((e = e.rgb()).r, e.g, e.b, e.opacity) : new ke()
      );
    }
    function we(e, t, n, r) {
      return 1 === arguments.length
        ? be(e)
        : new ke(e, t, n, null == r ? 1 : r);
    }
    function ke(e, t, n, r) {
    ...
    ee(ne, ye, {
      ...
      ee(
        ...
        function (e, t, n, r) {
          return 1 === arguments.length
            ? Te(e)
            : new Ce(e, t, n, null == r ? 1 : r);
        },
        te(ne, {
          brighter: function (e) {
            return (
              (e = null == e ? 1 / 0.7 : Math.pow(1 / 0.7, e)),
              new Ce(this.h, this.s, this.l * e, this.opacity)
            );
          },
          darker: function (e) {
            return (
          ...
          rgb: function () {
            var e = (this.h % 360) + 360 * (this.h < 0),
              ...
              i = 2 * n - r;
            return new ke(
              Pe(e >= 240 ? e - 240 : e + 120, i, r),
              Pe(e, i, r),
              Pe(e < 120 ? e + 240 : e - 120, i, r),
              this.opacity
            );
          },
          displayable: function () {
    ...
    var Re = (function e(t) {
      ...
      function r(e, t) {
        ...
        return function (t) {
          return (
            (e.r = r(t)), (e.g = i(t)), (e.b = o(t)), (e.opacity = a(t)), e + ""
          );
        };
      }
      return (r.gamma = e), r;
    ...
    var Ve = function (e, t) {
        var n,
          r,
          i,
          o = (We.lastIndex = Be.lastIndex = 0),
          a = -1,
          l = [],
          u = [];
        for (e += "", t += ""; (n = We.exec(e)) && (r = Be.exec(t)); )
          (i = r.index) > o &&
    ...
    var Xe = function (e, t) {
        ...
        return (
          t.forEach(function (t, r) {
            ...
            (e - Math.min.apply(Math, qe(i)) + 250) *
              (e - Math.max.apply(Math, qe(i)) - 250) <=
              0 &&
              o.forEach(function (t, i, o) {
                var a,
                  l,
                  u,
                  c,
    ...
    var Je = function (e, t) {
        ...
        V.startsWith("chrom") &&
          (n > 6e3 && n < 6600
            ? (document.querySelector("#leftroom").setAttribute("filter", Ge),
              document
                .querySelector("#filter3disp")
                .setAttribute("scale", parseInt(40 * Math.random(), 10)))
            : document
                .querySelector("#leftroom")
                .setAttribute("filter", "none")),
          Xe(n, e).forEach(function (e) {
            var n = e.selector,
              r = e.style;
      ...
      Ze = function (e) {
        for (
          var t = window.Math.ceil(e / 1), n = [], r = 1 / t, i = 0;
          i < t;
          i += 1
        )
          n.push(i * r);
    ...
    function et(e) {
      return (
        ...
        u.a.createElement(Y.a, { width: e.width, height: e.height })
      );
    }
    var tt = n(13);
    n(25);
    ...
    function ot() {
      ...
      return (
        ...
        u.a.createElement(
          "div",
          { id: "subContainer" },
          t && u.a.createElement("div", { id: "subtitles" }, t)
        )
      );
    }
    n(26);
    ...
    function ct() {
      ...
      return (
        ...
        u.a.createElement(
          ...
          u.a.createElement(ot, { isPortrait: t.isPortrait })
        )
      );
    }
    ...
    s.a.render(
      u.a.createElement(u.a.StrictMode, null, u.a.createElement(ct, null)),
      st
    ),
      (function (e, t) {
        var n,
